      ...
      <div style={styles.content}>
        ...
        <div style={styles.leftSide}>
          ...
          <p style={styles.welcomeDesc}>
            Discover the best dishes around you.<br />
            Real reviews from real food lovers in Hyderabad.
          </p>
        ...
        <div style={styles.formBox}>
          ...
          <p style={styles.formSubtitle}>Good to see you again</p>
...
const styles = {
  ...
  input: {
    ...
    background: '#fdf8f4',   // warm tint — matches page palette
    fontSize: '0.95rem',
    color: '#111827',
    fontFamily: 'Segoe UI, sans-serif',
    outline: 'none',
